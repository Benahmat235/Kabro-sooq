...
export const FilterButton: React.FC<FilterButtonProps> = ({
  ...
  // Size classes
  const sizeClasses = {
    sm: 'rounded-xl px-2.5 py-1.5 text-[11px] focus:ring-blue-500',
    md: 'rounded-2xl px-4 py-3 text-xs focus:ring-blue-500',
  }[size];
  ...
  if (variant === 'orange') {
    statusClasses = active
      ? 'bg-orange-600 text-white border-orange-600 shadow-sm focus:ring-orange-500'
      : 'bg-white text-gray-700 border-gray-100 hover:border-orange-200 hover:text-orange-600 focus:ring-orange-500';
  } else {
    statusClasses = active
